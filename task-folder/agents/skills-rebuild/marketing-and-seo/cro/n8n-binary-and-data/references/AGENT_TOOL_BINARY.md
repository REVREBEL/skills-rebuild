...
```
## Display Protocol
Show generated images inline using markdown: !`alt text`
Share generated VIDEO as a plain link, NOT an embed: `title`
```
...
| Embedding video as `![]()` | Broken thumbnail on most surfaces | Use ``title`` link form for video |
