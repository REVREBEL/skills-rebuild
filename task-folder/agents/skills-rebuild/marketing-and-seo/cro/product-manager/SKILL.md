...
description: "Senior PM agent with 6 knowledge domains, 30+ frameworks, 12 templates, and 32 SaaS metrics with formulas. Pure Markdown, zero scripts. Use when working with product manager or related tasks in marketing-and-seo/cro."
