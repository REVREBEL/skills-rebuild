...
First, check if `.agents/product-marketing.md` already exists. Also check `.agents/product-marketing.md` and the legacy filename `product-marketing-context.md` (in either `.agents/` or `.agents/`) for older setups — if found anywhere other than `.agents/product-marketing.md`, offer to move it to the canonical location.
