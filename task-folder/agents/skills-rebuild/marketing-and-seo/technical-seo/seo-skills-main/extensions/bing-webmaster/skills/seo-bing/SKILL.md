...
metadata:
  version: "2.0.0"
compatibility: "Requires BING_WEBMASTER_API_KEY and (optionally) INDEXNOW_KEY in ~/.agents/settings.json env. Run extensions/bing-webmaster/install.sh to configure."
---
