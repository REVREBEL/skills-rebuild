...
- **Name**: seo-geo-claude-skills — 20 SEO/GEO skills, 5 commands, shared references
...
- **After skill changes**: update tracking files (VERSIONS.md, `.agents-plugin/plugin.json`, marketplace.json, README.md, CLAUDE.md). For release bumps, also sync localized README badges and marketplace mirrors.
