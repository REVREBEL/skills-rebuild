...
description: "Generates Puppeteer scripts for browser automation, scraping, and PDF generation. Triggers on: \"Puppeteer\", \"headless Chrome\", \"page.goto\", \"scrape\", \"PDF generation\". Use when working with puppeteer skill or related tasks in workflow-and-automation/web-scraping."
