...
1. **Find problems others don't see** - Identify costly problems hidden in plain sight
2. **Design the category** - Create the rules that favor you
3. **Condition the market** - Make your problem feel urgent and your solution inevitable
4. **Execute Lightning Strikes** - Launch in ways that change how people think
5. **Become the Category King** - Capture 76% of market value, not 24%
...
1. What do our best customers complain about that we thought was "just how it is"?
2. What takes our customers 10x longer than it should?
3. What are our customers apologizing to THEIR customers about?
4. What would our customers' CEO care about that their current vendors can't solve?
5. If we could wave a magic wand, what reality would we create?
...
**Naming Exercise**:
Complete this sentence: "We invented _____________ so that [customer] can [outcome]."
...
### 1. Context
What's happening in the world that sets the stage for this problem?
[2-3 sentences about trends, shifts, changes]

### 2. The Problem
What problem hasn't been solved—or hasn't been solved well?
[Describe in visceral, specific terms]

### 3. The Villain
What's the shorthand name for this problem?
"The [X] Gap" / "The [X] Crisis" / "[X] Chaos"

### 4. Why Current Approaches Fail
Why haven't existing solutions worked?
[2-3 specific reasons with evidence]
...
What does the world look like when this problem is solved?
[Paint a compelling picture]

### 7. The Category
We call this [CATEGORY NAME].
...
**Gravity Warning**:
"Gravity" is the day-to-day grind that pulls you back to old ways—current customer demands, existing sales motions, quarterly targets. You must actively fight gravity to create a new category.
...
**Before (Competing):**
"We're a project management tool that's faster and more intuitive than Monday.com and Asana."
...
**Before (Competing):**
"We make premium athletic wear that's more sustainable than Lululemon."
...
CP = [# with problem] × [$ willing to pay]
CP = ___ × $___
**CP = $___/year**
...
- **Website**: [PlayBigger.com](https://www.playbigger.com)
