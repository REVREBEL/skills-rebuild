...
description: "Lightweight Google Drive integration with standalone OAuth authentication. No MCP server required. Full read/write access. Use when working with google drive automation or related tasks in development/backend."
