...
description: "Smart change detection, auto branch naming, and streamlined commit/PR workflow. Use when working with smart git automation or related tasks in development/fullstack."
