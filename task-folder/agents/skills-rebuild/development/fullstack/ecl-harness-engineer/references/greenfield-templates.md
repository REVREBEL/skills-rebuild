...
- `Architecture Overview` — System design, layers, data flow
- `Development Setup` — Build, test, environment

## 2 Architecture

| Section | Document | Description |
|---------|----------|-------------|
| 2.1 | `System Architecture` | Layer hierarchy, dependency graph, data flow |
| 2.2 | `Design Documents` | Component deep-dives (to be added) |

## 3 Quality & Standards

| Section | Document | Description |
|---------|----------|-------------|
| 3.1 | `Code Quality` | Golden principles, linter rules |
| 3.2 | `Testing Standards` | Test patterns, coverage |
| 3.3 | `Security Policy` | Security considerations |
| 3.4 | `Quality Score` | Per-domain quality grades |
...
- `Quality Score` — Quality tracking
```
