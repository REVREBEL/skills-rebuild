...
```console
rclone copy --progress ~/directory/file.ext remote:bucket/path/to/dir/
```
...
```console
rclone copy --progress ~/directory/ remote:bucket/path/to/dir/
```
...
```console
rclone copy --progress remote:bucket/path/to/dir/file.ext ~/directory/
```
...
```console
rclone copy --progress remote:bucket/path/to/dir/ ~/directory/
```
...
```console
rclone sync --interactive --progress ~/directory/ remote:bucket/path/to/dir/
```
...
```console
rclone sync --interactive --progress remote:bucket/path/to/dir/ ~/directory/
```
