...
Checks a remote against an `encrypted` remote. This is the equivalent
of running rclone `check`, but able to check the
...
The default number of parallel checks is 8. See the `--checkers`
