...
- `Size` - these are returned as an integer number of bytes. They may
  ...
  eg "10M". See the `options section` for more info.
...
See the `config providers` command
...
relevant `rclone serve` command line options.
...
This returns stats for the selected VFS.

    {
        ...
        "diskCache": {
            ...
            "hashType": 1,
            "outOfSpace": false,
            "path": "~/.cache/rclone/vfs/local/mnt/a",
            "pathMeta": "~/.cache/rclone/vfsMeta/local/mnt/a",
            "uploadsInProgress": 0,
            "uploadsQueued": 0
        },
        "fs": "/mnt/a",
