...
description: "Use this skill when the user asks about \"BigQuery\", \"analytics queries\", \"data warehouse\", \"partitioning\", \"clustering\", \"SQL queries\", or any BigQuery-related work. Provides BigQuery table design, query optimization, and Node.js integration patterns. Use when working with bigquery analytics or related tasks in data-and-ai/analytics."
