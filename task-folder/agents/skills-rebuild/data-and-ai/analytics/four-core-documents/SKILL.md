...
3. TG prioritisation
4. Sub-TG breakdown
5. Persona development per primary TG (using `actionable-persona-format.md`)
...
1. Channel universe considered (using `five-digital-markets.md`)
...
5. Budget allocation logic at business level (with In-Market vs Out-Market split per `in-market-out-market.md`)
...
- `channel-families.md` for the 7-family / 17-channel taxonomy
...
8. **Multi-Dimensional Decision Framework** (see `decision-framework.md`) is used for any choice (channel selection, persona prioritisation, positioning trade-offs).
...
- `four-core-documents-spec.md` — the canonical 61-step specification
- `actionable-persona-format.md` — Step 5 of 3.2
- `b2b-decision-making-unit.md` — Steps 10-13 of 3.2 (B2B)
- `five-digital-markets.md` — Step 1 of 3.4
- `in-market-out-market.md` — Step 5 of 3.4
- `channel-families.md` — Step 2 of 3.4
- `decision-framework.md` — used throughout for choice-making
- `unit-economics-framework.md` — Step 4 of 3.1
