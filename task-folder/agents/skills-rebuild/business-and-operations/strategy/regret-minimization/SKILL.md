...
- **Career decisions** with long-term implications
- **Startup vs. safe job** choices
- **Major life pivots** (relocations, relationships, changes)
- **Risk-taking decisions** where fear is a factor
- **Opportunity evaluation** when considering bold moves
- **Any decision you'll look back on** in 10-20+ years
...
1. **Reframes decisions to long-term view** - Cuts through short-term fear
2. **Distinguishes regrets of action vs. inaction** - Most regrets are things we didn't do
3. **Evaluates opportunity uniqueness** - Is this a one-time window?
4. **Assesses downside survivability** - Can you recover if it fails?
5. **Clarifies personal values** - What actually matters to you?
6. **Enables bold action** - Gives permission to take calculated risks
...
### The Decision
- **Option A:** Leave Google to pursue startup full-time
- **Option B:** Stay at Google, work on startup nights/weekends

### Project to Age 80

**If you leave and the startup succeeds:**
"I left a comfortable job to build something meaningful. It was scary but it defined my life. I'm proud I took the leap."
→ Regret: ZERO

**If you leave and the startup fails:**
"I tried. I learned more in 2 years of startup than 10 at Google. I went back to tech. I have no 'what ifs.'"
→ Regret: LOW

**If you stay at Google:**
"I had a good career. Comfortable. But I always wondered what would have happened with that startup. I had traction and I didn't try."
→ Regret: POTENTIALLY HIGH
...
**Is this a rare window?**
- ✅ You have early traction (validation others don't have)
- ✅ You're young enough to take the risk
- ✅ You don't have kids yet (or obligations that would grow)
- ✅ The market is hot for your idea NOW
- ⚠️ At Google, you might vest more stock, but...
- ⚠️ Staying might mean the window closes

### The Bezos Test

"I knew that when I was 80 I was not going to regret having tried this.
I was not going to regret trying to participate in this thing...
I knew that if I failed I wouldn't regret that,
but I knew the one thing I might regret is not ever having tried."

**Your version:**
"At 80, will I regret leaving a comfortable Google job to build something?
If it fails, will I regret trying?
Or will I regret staying at Google and always wondering?"
...
Your 80-year-old self will almost certainly thank you for trying.
Your 80-year-old self might haunt you with "what ifs" if you don't.

The downside is capped (2-3 years, recoverable career).
The upside is unlimited (life-defining company).

**Action plan:**
1. Set a runway (12-18 months of committed try)
2. Define success/failure criteria
3. Make the leap with a plan, not recklessly
4. If it fails, you'll return stronger and wiser
...
**If you move and it's amazing:**
"I took a chance. I saw the world. I grew in ways I never imagined. Best decision I ever made."
→ Regret: ZERO

**If you move and it doesn't work out:**
"I tried living abroad. It wasn't for me. But I learned, I grew, I have stories, and I came home knowing myself better."
→ Regret: LOW

**If you don't move:**
"I had this incredible opportunity once. A dream job in [place]. I was too scared. I stayed comfortable. I always wondered what my life would have been."
→ Regret: POTENTIALLY HIGH
...
1. **Is this opportunity unique?**
   - Will this exact job exist in 5 years? Probably not.
   - Will you be in a position to take it later? Harder with age/obligations.

2. **Can you return?**
   - Yes. Your city will be there. Your true friends will be there.
...
You haven't actively chosen to stay. You've just... not left.
This is the "default path" that leads to many regrets.

### Project to Age 80

**If you stay another 10 years:**
"I was comfortable. I was fine. But I didn't grow. I didn't challenge myself. I wonder what I was capable of."
→ Regret: Creeping, existential

**If you leave and find something better:**
"I took a risk. I grew. I'm glad I pushed myself."
→ Regret: ZERO

**If you leave and it doesn't work out:**
"I tried something new. It didn't work. But I came back to something similar, knowing I had tested myself."
→ Regret: LOW
...
- Skills atrophy when not challenged
- Market value decreases over time
- "Comfortable" becomes "stuck"
- You wake up at 50 wondering what happened
...
Your 80-year-old self doesn't brag about comfort.
They brag about challenges, growth, and having TRIED.
...
- Bezos, Jeff. Various interviews (1994-present) - Origin of framework
- Gilovich, Thomas & Medvec, Victoria. "The Experience of Regret" - Psychology research
- Bronnie Ware. "The Top Five Regrets of the Dying" - Deathbed regrets
- Kahneman, Daniel. "Thinking, Fast and Slow" - Loss aversion bias
- Holiday, Ryan. "The Obstacle Is the Way" - Related Stoic philosophy

## Related Skills

- `second-order-thinking` - Consider consequences of choices
- `reversible-decisions` - Type 1 vs. Type 2 decisions
- `first-principles` - Challenge assumptions about risk
- `inversion` - Think backward from failure
- `pre-mortem` - Anticipate what could go wrong
...
source_work: Amazon founding decision, various interviews
difficulty: beginner
estimated_value: $1,500 career coaching session
tags: [decisions, Bezos, Amazon, risk, career, life-choices, mental-models]
created: 2026-01-25
updated: 2026-01-25
```
