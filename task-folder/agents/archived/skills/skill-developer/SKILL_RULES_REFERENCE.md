...
Complete schema and configuration reference for `.agents/skills/skill-rules.json`.
...
**Path:** `.agents/skills/skill-rules.json`
...
```bash
cat .agents/skills/skill-rules.json | jq .
```
