...
22. **Read before write.** Before writing in an unfamiliar repo, read the file you'll edit, one neighbor, and any project rules file (AGENTS.md, README's "conventions" section). Use the project's existing helpers, error types, and logging.
