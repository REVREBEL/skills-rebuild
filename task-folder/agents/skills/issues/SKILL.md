...
Use AskUser to ask what the user wants to do:
...
Use AskUser to get the issue title:
...
Use AskUser to gather the issue body content:
...
If issue type is "Bug", use AskUser:
...
Use AskUser to determine filtering:
...
If "With specific label" selected, use AskUser:
