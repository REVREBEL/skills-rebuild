...
1. **Research your customer** - Deep understanding before writing
2. **Find your "big idea"** - The concept that drives the letter
3. **Craft your headline** - The most important element
4. **Structure your letter** - Proven flow that converts
5. **Write persuasive body copy** - Benefits, proof, and story
6. **Build an irresistible offer** - Stack value, remove risk
7. **Create urgency and close** - Drive immediate action
8. **Refine and test** - Optimize for maximum response
...
1. **Make it specific** - Numbers and details create believability
2. **Promise a benefit** - What's in it for them?
3. **Create curiosity** - But don't be clever-cryptic
4. **Qualify the reader** - Self-select your audience
...
10. BONUSES
    ...
    └── Should relate to main offer
    └── Create "pile on" effect

11. PRICE REVEAL
    └── Compare to alternatives
    └── Break down to daily/monthly cost
    └── Show the value vs. price gap

12. GUARANTEE
    └── Remove all risk
    └── Make it bold and specific
    └── "Better than money back" if possible

13. URGENCY/SCARCITY
    └── Why they must act NOW
    └── Real deadlines or limits
...
15. P.S. SECTION
    ...
    └── Remind of urgency
    └── Often read first (after headline)
```
...
1. **Hook** - Stop them from leaving
2. **Empathize** - Show you understand
3. **Promise** - Hint at the solution
...
had tried everything—[list failed attempts].
...
why [the counterintuitive thing] is true—and how you can
...
3. **Use "you" liberally**
4. **Write conversationally** (like a letter to a friend)
5. **Be specific** ("37 pounds in 6 weeks" not "lose weight")
6. **Use stories** (people remember stories, not facts)
...
```
"Look, I'll be honest with you—this isn't cheap."
"I'm not going to lie—this requires work."
...
✓ [Core Offer] .......................... $997 value
✓ [Bonus #1] ............................ $197 value
✓ [Bonus #2] ............................ $297 value
✓ [Bonus #3] ............................ $497 value
✓ [Fast-Action Bonus] ................... $300 value
...
1. **Better Than Money Back** - "Keep the bonuses even if you refund"
2. **Results Guarantee** - "If you don't [specific result], full refund"
3. **Unconditional** - "No questions asked, full refund"
4. **Conditional** - "Complete the program, and if no results, refund"
...
P.P.S. [Urgency reminder]—the [bonus/price] expires
...
company into a $2.1 million success story—in just 90 days.
...
email—a shift that, once you make it, changes everything.
```
...
**P.S.:**
```
P.S. Remember—you're protected by my "Double Your Email
...
until Friday—then the price goes up to $997.
```
...
Per Month—Without Cold Calling, Ads, or Posting Content
```
...
your competitors are using a completely different approach—
...
refund your entire investment—no questions asked.
...
Not because of some fake scarcity—but because we do
...
KNOW YOUR PRODUCT:
□ What is the main transformation/result?
...
KNOW YOUR OFFER:
□ What's included?
□ What bonuses can you add?
□ What guarantee removes risk?
□ What urgency/scarcity is real?
```
...
□ Is it believable yet surprising?
□ Does it qualify the right reader?
□ Would YOU click on it?
□ Have you written at least 25 alternatives?
```
...
TECHNIQUES TO USE:
□ Headline approach: ____________________
□ Opening hook: ____________________
□ Proof element: ____________________
□ Close technique: ____________________
```
