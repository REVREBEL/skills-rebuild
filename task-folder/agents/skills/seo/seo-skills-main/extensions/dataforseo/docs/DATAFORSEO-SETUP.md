...
If the installer's auto-configuration fails, add this to `~/.agents/settings.json`:
  ...
  "mcpServers": {
    "dataforseo": {
      ...
      "env": {
        ...
        "FIELD_CONFIG_PATH": "/home/youruser/.agents/skills/seo/dataforseo-field-config.json"
      }
    }
  }
}
