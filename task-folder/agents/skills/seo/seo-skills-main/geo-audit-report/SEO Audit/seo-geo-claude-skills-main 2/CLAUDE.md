...
- After updating a skill, keep the tracking files in step: `VERSIONS.md`, `.claude-plugin/plugin.json`, the root `marketplace.json` and its `.claude-plugin/marketplace.json` mirror, `README.md`, and this `AGENTS.md`.
