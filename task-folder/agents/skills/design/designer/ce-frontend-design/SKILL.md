...
Use the platform's native file-search and content-search tools (e.g., Glob/Grep in the agent) to scan for these signals. Do not use shell commands for routine file exploration.
