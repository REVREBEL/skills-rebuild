...
```
Investment:
- Product/service cost: $X/year
- Implementation cost: $Y (one-time)
- Internal time investment: Z hours x hourly rate

Returns:
- Revenue increase: $A/year
- Cost savings: $B/year
- Time savings: C hours/year x hourly rate = $D/year

Total annual return: $A + $B + $D = $Total
ROI: ($Total - Annual Investment) / Annual Investment x 100 = ___%
Payback period: Total Investment / Monthly Return = ___ months
```
...
Your results with [Product] have been outstanding — [specific metric].
We'd love to share your success story to help other [industry] companies
facing similar challenges.

Here's what it involves:
- A 30-minute interview (we'll send questions in advance)
- We write the draft — you review and approve before anything goes live
- Your final say on everything published

We've found our case study customers get [benefit: visibility, conference
speaking invitations, co-marketing exposure].
