...
12. **Return import summary and log results**: Compile final results and log the complete import — timestamp, source attribution, record counts, scoring distribution, assignment breakdown, nurture enrollments, notifications sent, errors, and duration — to `~/.agents-marketing/brands/{slug}/logs/lead-import-log.json`.
