...
[6 actionable persona questions answered]

### DMU Overlay

#### As Influencer (Primary Role for This Persona)
- Care about: technical capabilities, integration depth, scaling characteristics, security posture
- Fear: recommending a tool that fails, missing a better alternative
- Win with: detailed comparison guides, technical whitepapers, customer references in similar tech stacks
- Reach via: LinkedIn long-form content, technical webinars, GitHub presence

#### Likely Decision-maker (CFO or CEO depending on company size)
- Care about: 3-year TCO, ROI vs build-vs-buy, vendor stability
- Reach via: ABM with executive-targeted content, peer references at similar companies

#### Likely User (Engineering team members)
- Care about: developer experience, documentation quality, learning curve
- Reach via: GitHub, dev blog content, tutorial videos

#### Likely Gatekeeper (Procurement + IT Security)
- Care about: SOC 2 / ISO 27001 status, data residency, contract terms
