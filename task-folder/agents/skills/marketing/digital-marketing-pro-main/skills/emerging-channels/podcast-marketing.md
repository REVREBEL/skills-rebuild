...
> Hi {{host name}},
>
> I'm a listener of {{podcast name}} and particularly enjoyed your episode on {{specific episode}}. I'm reaching out because I think your audience would benefit from a conversation about {{topic}}.
>
> Quick background: I'm {{your name}}, {{title}} at {{company}}. I've {{relevant credential: built X, published Y, worked with Z}}.
>
> Here are 3 angles I could cover:
> 1. {{Angle 1 — specific, actionable, interesting}}
> 2. {{Angle 2 — specific, actionable, interesting}}
> 3. {{Angle 3 — specific, actionable, interesting}}
>
> I'm happy to tailor the topic to what fits your show best. {{Link to previous podcast appearances or media kit if available.}}
>
...
> Hi {{guest name}},
>
> I host {{podcast name}}, a {{description — weekly show about X for Y audience}}. We have {{audience size/download numbers}} and our listeners include {{relevant audience description}}.
>
> I'd love to have you on to discuss {{specific topic}}. Your work on {{their relevant expertise}} is exactly what our audience needs.
>
> The commitment is {{time: 30-45 minutes}}, recorded via {{platform: Riverside/Zoom}}. We handle all editing and promotion, and we'll share the episode across our {{channels and audience size}}.
>
> Would you be open to recording in the next {{timeframe}}?
>
> Best,
> {{your name}}
...
```json
{
  ...
  "@type": "PodcastSeries",
  "name": "The SaaS Growth Show",
  "description": "Weekly conversations with SaaS founders and growth leaders...",
  "url": "https://example.com/podcast",
  "author": {
    "@type": "Person",
    "name": "Host Name"
  },
  "webFeed": "https://feeds.example.com/saas-growth-show"
}
```
