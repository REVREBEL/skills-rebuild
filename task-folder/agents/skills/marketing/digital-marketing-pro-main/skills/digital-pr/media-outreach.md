...
Noticed your recent piece on [their article topic]. Thought you'd be interested:

[Brand] just launched [product] that [specific, newsworthy claim].
...
Happy to share [demo access / exclusive data / founder interview].
...
We just completed [study description] analyzing [scope — e.g., "10,000 marketing campaigns"].
...
Full report available for [exclusive / early] access. Also happy to provide expert commentary from [expert name, title].
...
Following the news about [current event], [Expert Name], [title] at [Brand], is available to comment on [specific angle].

[Expert] has [credentials: X years experience, published in Y, previously at Z].

Quick take: "[One compelling quote on the topic]"

Available for phone/video/email interview. Can turn around written quotes within [timeframe].
