...
I'd like to propose a talk for [Event]: "[Talk Title]"

This talk covers [1-2 sentence description] based on [unique data/experience].

About me:
- [Title] at [Company]
- [Relevant credential or achievement]
- Previous speaking: [1-2 past events]

The audience will walk away with [specific takeaway].

Happy to share a full abstract and outline.
