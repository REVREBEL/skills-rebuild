...
│                                                      │
│  COMPETITOR OVERVIEW                                 │
│  Company: [Name] | Founded: [Year] | HQ: [Location] │
│  Size: [Employees] | Funding: [Amount/Stage]         │
│  Pricing: [Model + range]                            │
│  Target market: [Who they sell to]                   │
│  Key products: [Product lines]                       │
│                                                      │
├────────────────────────────────────────────────────┤
...
│                                                      │
├────────────────────────────────────────────────────┤
│  THEIR WEAKNESSES (verified, not rumors)             │
│  • [Weakness 1]                                      │
│  • [Weakness 2]                                      │
│  • [Weakness 3]                                      │
│                                                      │
├────────────────────────────────────────────────────┤
│  OUR DIFFERENTIATORS                                 │
│  • [Differentiator 1] — [proof point]                │
│  • [Differentiator 2] — [proof point]                │
│  • [Differentiator 3] — [proof point]                │
│                                                      │
├────────────────────────────────────────────────────┤
│  TRAP QUESTIONS                                      │
│  Ask the prospect these to expose competitor gaps:   │
│  • "[Question that highlights their limitation]"     │
│  • "[Question about feature they lack]"              │
│  • "[Question about scaling concern]"                │
│                                                      │
├────────────────────────────────────────────────────┤
│  WIN THEMES                                          │
│  When we win against [Competitor], it's because:     │
│  • [Theme 1 with customer example]                   │
│  • [Theme 2 with data point]                         │
│                                                      │
├────────────────────────────────────────────────────┤
│  CUSTOMER PROOF POINTS                               │
│  "[Quote from customer who switched from them]"      │
│  — [Name, Title, Company]                            │
│                                                      │
│  "[Quote about choosing us over them]"               │
│  — [Name, Title, Company]                            │
└────────────────────────────────────────────────────┘
```
...
I noticed [specific, researched observation — recent hire, product launch,
funding round, job posting, technology change].

Companies in [their industry] going through [that situation] typically
face [specific challenge you solve]. [Company similar to theirs] tackled
this by [brief solution mention] and saw [one specific result].

Worth a 15-minute conversation to see if something similar could work
for [their company]?
...
Wanted to share [specific resource: case study, industry report, benchmark
data] — it covers how [similar company/industry] is handling [the challenge
you mentioned in outreach].

Key takeaway: [one compelling stat or insight from the resource].

Happy to walk through how this applies to [their company] specifically.
...
I'll assume the timing isn't right and close your file. If [the challenge
you solve] becomes a priority, my door is always open.

In the meantime, here's [valuable resource] that might be useful regardless.
...
I work with several companies that switched from [Competitor] to [Your product].
The most common reasons were [reason 1] and [reason 2].

[Customer name] made the switch 6 months ago and saw [specific result].

Curious — are you experiencing any of those same challenges with [Competitor]?

If it's working well for you, that's great. But if you're open to seeing what
[specific improvement] looks like, I'd love to show you in 15 minutes.
...
Glad to hear [positive outcome or recent success with your product]. That's
exactly the kind of result we love seeing.

I'm wondering — do you know anyone in [specific role] at a [similar company
type] who might be facing the same challenges you were before we started
working together?

A warm intro would mean a lot. Happy to make it easy — I can draft a short
blurb you could forward if that helps.
...
2. Reframe — Provide new context or perspective
...
│   └── Re-engagement/
├── Proposal Templates/
│   ├── Standard Proposal Template.docx
│   ├── Enterprise Proposal Template.docx
│   └── ROI Calculator.xlsx
├── Objection Handling/
│   └── Objection Handling Playbook.pdf
├── Demo Resources/
│   ├── Demo Script — Standard.md
│   ├── Demo Script — Enterprise.md
│   └── Demo Environment Setup.md
└── Pricing/
    ├── Pricing Guide (Internal Only).pdf
