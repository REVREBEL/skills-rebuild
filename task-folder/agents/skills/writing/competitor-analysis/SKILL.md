...
allowed-tools: Bash Agent clarifying question
metadata:
  author: browserbase
  version: "0.2.0"
category: "marketing"
...
Ask clarifying questions via `clarifying question` with checkboxes:
...
3. Use `clarifying question` with a checkbox list of all candidates across the three buckets, plus a free-text "add more" field. The prompt should be explicit:
