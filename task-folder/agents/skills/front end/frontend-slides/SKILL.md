...
**Ask ALL questions in a single clarifying question call** so the user fills everything out at once:
...
5. **Confirm via clarifying question** (header: "Outline"): "Does this slide outline and image selection look right?" Options: Looks good / Adjust images / Adjust outline
