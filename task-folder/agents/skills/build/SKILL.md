...
If the feature name is not provided in arguments, you MUST use clarifying question to prompt for it.
...
Then use clarifying question to ask what they'd like to do:
...
If feature name not in arguments, use clarifying question:
...
If it exists, use clarifying question:
...
Use clarifying question to understand the feature:
...
4. **Use clarifying question FREQUENTLY**: Validate assumptions, clarify requirements, get input on decisions
...
If feature name not in arguments, use clarifying question to prompt for it (same as research phase).
...
Use clarifying question to validate phase breakdown:
...
Use clarifying question for any uncertainties about phase ordering or scope.
...
If feature name not in arguments, use clarifying question to prompt for it.
...
If neither provided, prompt for both using clarifying question.

### Step 2: Get Feature Name

If feature name not determined, use clarifying question to prompt for it.
...
Use clarifying question to let user select:
...
3. **Use clarifying question** to clarify any ambiguities about the phase requirements
...
2. Use clarifying question frequently for implementation decisions
...
### Use clarifying question Liberally

Throughout all phases, use clarifying question whenever:
...
- Use clarifying question to validate if something is in/out of scope
